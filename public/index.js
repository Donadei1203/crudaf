function btologin() {
    ...
    fetch('https://crudaf-1.onrender.com/usuarios').then(resposta => resposta.json()).then(data => {
        ...
        if(admin){
            ...
            window.location.href = "https://crudaf-1.onrender.com/pages/usuarios.html";
            console.log('Admin')
        }else if(usuario){
            localStorage.setItem('loginLS', login);
            localStorage.setItem('senhaLS', senha);
            window.location.href = "https://crudaf-1.onrender.com/pages/boasvindas.html";
            console.log('usuario')
    }
        else{
